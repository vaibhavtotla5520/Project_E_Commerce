...
if(isset($_GET['p_id'])) {
    $data = $obj->get_product_details($_GET['p_id']);
				...
				<div class="col-md-10 col-md-offset-1 animate-box">
                    ...
                    <?php
                        foreach($images as $image) {
                            echo '<div class="item" style="width:70%; margin:auto;">
							<div class="active text-center">
								<figure>
									<img src="images/'.$image.'.jpg" alt="user">
								</figure>
							</div>
						</div>';
                        }
					...
					<div class="row animate-box">
						<div class="col-md-8 col-md-offset-2 text-center fh5co-heading">
							...
							<p>
								...
								<a href="#" class="btn btn-primary btn-outline btn-lg">Buy Now</a>
							</p>
						</div>
					</div>
				</div>
						...
						<div class="fh5co-tab-content-wrap">
							...
							<div class="fh5co-tab-content tab-content active" data-tab-content="1">
								<div class="col-md-10 col-md-offset-1">
                                    ...
                                    <table>
                                    <?php
                                        $details = explode('-',$data['product_details']);
